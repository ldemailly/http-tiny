 ...
 */
static int http_read_line(fd, buffer,
                          max) int fd; /* file descriptor to read from */
 ...
 */
static int http_read_buffer(fd, buffer,
                            length) int fd; /* file descriptor to read from */
char *buffer;                               /* placeholder for data */
 ...
 */
static http_retcode http_query(command, url, additional_header, mode, data,
                               length, pfd) char *command; /* command to send */
...
http_retcode http_put(
    filename, data, length, overwrite,
    type) char *filename; /* name of the ressource to create */
...
http_retcode http_get(
    filename, pdata, plength,
    typebuf) char *filename; /* name of the ressource to read */
...
http_retcode http_delete(
    filename) char *filename; /* name of the ressource to create */
